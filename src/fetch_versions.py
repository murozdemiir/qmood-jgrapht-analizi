...
REPO_URL = "https://github.com/jgrapht/jgrapht"
ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
DATA = os.path.join(ROOT, "data")
CLONE_DIR = os.path.join(DATA, "_jgrapht_repo")
VERSIONS_DIR = os.path.join(DATA, "versions")

# Yazilim evrimini (0.9 -> 1.5) kapsayacak sekilde secilmis 11 surum.
# 0.9 -> 1.0 buyuk yeniden yazimi dahil; buyume 182 -> 464 java dosyasi.
SELECTED = [
    "0.9.0",
    "0.9.2",
    "1.0.0",
...
# JGraphT cok modulludur; nesne yonelimli cekirdek jgrapht-core modulundedir.
SRC_SUBPATH = "jgrapht-core/src/main/java"
